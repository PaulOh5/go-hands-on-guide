...
type RepoBuild struct {
	...
	Timestampe string `protobuf:"bytes,2,opt,name=timestampe,proto3" json:"timestampe,omitempty"`
}

func (x *RepoBuild) Reset() {
	*x = RepoBuild{}
	if protoimpl.UnsafeEnabled {
...
func (x *RepoBuild) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RepoBuild) ProtoMessage() {}

func (x *RepoBuild) ProtoReflect() protoreflect.Message {
	mi := &file_repositories_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RepoBuild.ProtoReflect.Descriptor instead.
func (*RepoBuild) Descriptor() ([]byte, []int) {
	return file_repositories_proto_rawDescGZIP(), []int{3}
}

func (x *RepoBuild) GetLogLine() string {
	if x != nil {
		return x.LogLine
	}
	return ""
...
func (x *RepoBuild) GetTimestampe() string {
	if x != nil {
		return x.Timestampe
	}
	return ""
...
var file_repositories_proto_rawDesc = []byte{
	...
	,
...
var file_repositories_proto_depIdxs = []int32{
	...
	1, // 3: Repo.CreateBuild:input_type -> Repository
	2, // 4: Repo.GetRepos:output_type -> RepoGetReply
	3, // 5: Repo.CreateBuild:output_type -> RepoBuild
